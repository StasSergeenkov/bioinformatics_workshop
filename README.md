...
# Основная часть
## Подготовка исходных данных
_основные каталоги:_
_1. /1_row_data (недоступен на Github) - просто загруженные сборки_
_2. [/2_working_data](/2_working_data) - непосредственно подготовка исходных данных_
